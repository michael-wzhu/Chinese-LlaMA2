        ...
        while True:
            ...
            while not self.input_queue.empty():
                ...
                sampling_params = SamplingParams(
                    n=1,
                    best_of=gen_input.sampling_config.get('best_of', 1),
                    use_beam_search=gen_input.sampling_config.get('use_beam_search', False),
                    top_p=gen_input.sampling_config.get('top_p', 1.0),
                    top_k=gen_input.sampling_config.get('top_k', -1),
                    max_tokens=gen_input.sampling_config.get('max_tokens', 512),
                    presence_penalty=gen_input.sampling_config.get('presence_penalty', 0.2),
                    frequency_penalty=gen_input.sampling_config.get('frequency_penalty', 0.2),
                    temperature=gen_input.sampling_config.get('temperature', 1e-6),
                )
...
CUDA_VISIBLE_DEVICES="3" python src/promptcblue_llama_peft/vllm_serving/launch_vllm.py \
    --port 8090 \
    --model /public/home/xlwang2/codes/ChatMed/experiments/output/promptcblue-llama-7b-pt-v0/checkpoint-800-merge \
    --use-np-weights \
