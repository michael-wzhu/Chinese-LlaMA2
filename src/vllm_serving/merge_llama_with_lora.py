"""
Usage: 
CUDA_VISIBLE_DEVICES="3" python src/promptcblue_llama_peft/vllm_serving/merge_llama_with_lora.py \
    --base_model /public/home/xlwang2/codes/Med_Prompts/resources/chinese-llama-plus-lora-7b \
